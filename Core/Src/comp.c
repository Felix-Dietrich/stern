...
void HAL_COMP_MspInit(COMP_HandleTypeDef* compHandle)
{
  ...
  /* USER CODE END COMP1_MspInit 0 */
    ...
    PA1     ------> COMP1_INP
    */
    GPIO_InitStruct.Pin = I_SNS_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(I_SNS_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END COMP2_MspInit 0 */
    ...
    PA3     ------> COMP2_INP
    */
    GPIO_InitStruct.Pin = U_SNS_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(U_SNS_GPIO_Port, &GPIO_InitStruct);
...
void HAL_COMP_MspDeInit(COMP_HandleTypeDef* compHandle)
{
  ...
  /* USER CODE END COMP1_MspDeInit 0 */
    ...
    PA1     ------> COMP1_INP
    */
    HAL_GPIO_DeInit(I_SNS_GPIO_Port, I_SNS_Pin);
  ...
  /* USER CODE END COMP2_MspDeInit 0 */
    ...
    PA3     ------> COMP2_INP
    */
    HAL_GPIO_DeInit(U_SNS_GPIO_Port, U_SNS_Pin);
